          ...
          <div className="bloghome__intro">
            <animated.div style={animatedTexts[0]} className="hero_text">
              ...
              <span className="intro__name">
                <Translate description="my name">Sebastian</Translate>
              </span>
            </animated.div>
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <a href="https://space.bilibili.com/197747242">
        <BilibiliIcon />
      </a>
      {/* <a href="https://www.linkedin.com/in/zxuqian/">
        <FontAwesomeIcon icon={faLinkedin} size="lg" />
      </a> */}
      <a href="https://github.com/Sebastian520">
        <FontAwesomeIcon icon={faGithub} size="lg" />
      </a>
      <a href="https://blog.csdn.net/weixin_43420346?spm=1000.2115.3001.5343">
        <CSDNIcon />
      </a>
